...
function init(d_start,d_end)
{
     ...
     document.writeln("<div name=\"cele_date\" id=\"cele_date\"  style=\"display:none;width:250;\" style=\"LEFT: 69px; POSITION: absolute; TOP: 159px;Z-INDEX:99\" onClick=\"event.cancelBubble=true;\" onBlur=\"hilayer()\" onMouseout=\"lostlayerfocus()\">-</div>");
     window.cele_date.innerHTML="";
     temp_str="<table border=\"1\" bgcolor=\"#FFFFE8\" bordercolor=\"#808080\"><tr><td colspan=7 onmouseover=\"overcolor(this)\">";
     ...
     temp_str+="<font color=red>日</font></td><td align=center>一</td><td align=center>二</td><td align=center>三</td><td align=center>四</td><td align=center>五</td><td align=center>六</td></tr>";
     for (i=1 ;i<=6 ;i++)
     {
     temp_str+="<tr>";
        for(j=1;j<=7;j++){
            temp_str+="<td name=\"c"+i+"_"+j+"\"id=\"c"+i+"_"+j+"\" style=\"CURSOR: hand\" style=\"COLOR:#000000\" language=\"javascript\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" onclick=\"td_click(this)\" align=center>?</td>"
            }
     temp_str+="</tr>"        
     }

...
<FORM METHOD="POST" ACTION="{$action}" name="PostForm" onSubmit="return CheckPostForm(this);">
	...
	<tr>
		...
		<br />日期：<INPUT TYPE="text" NAME="DDateTime" value="{$PostData}" onfocus="show_cele_date(DDateTime,'','',DDateTime)"/>
		</td>
	</tr>
	{$TopicFunction1}
	{$Show_Payto}
...
<![CDATA[
	<tr>
		<td class="reply_t2" style="heiht:148px;">文件上传：<input type="hidden" name="upfilerename" value=""/></td>
		<td class="reply_t3">
		<iframe name="UPLOADFRAME" frameborder="0" width="100%" height="24" scrolling="no" src="BokeUpload.asp?mode=UploadForm" class="iframestyle"></iframe>
		</td>
	</tr>
]]>
</xsl:variable>
...
function setid()
{
	...
	str+='<input type="file" name="file'+i+'" style="width:200px"/><br/>';
...
<TD id="upid" valign="top" align="left" class="reply_t3" width="80">
<input type="file" name="file1" value="" size="25"/>&nbsp;</TD>
<td valign="top" width="35" align="left" class="reply_t3">
<input type="submit" name="Submit" value="上传" onclick="parent.document.PostForm.submit.disabled=true"/>&nbsp;
</td>
<td id="allupload" valign="top" align="left" class="reply_t3"></td>
...
<!--
if (upset > 1){
var tempstr1='<input type="button" name="setload" onClick="uploadframe(0);" value="批量"/>';
var tempstr2='<input type="text" value="1" name="upcount" size="1" maxlength="1"/><input type="button" name="Button" onClick="setid();" value="设定"/>';

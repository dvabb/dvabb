...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="32">
	  ...
	  <td background="skins/images/bg2.gif"><span style="float:left">官方公告：</span><span style="color:#c00; font-weight:bold; float:left;width:300px;" id="dvbbsannounce"></span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:url(skins/images/botbg.gif)">
  <tr height="32">
	...
	<td style="text-align:right; color: #135294; padding-right:20px;"><a href="reloadforumcache.asp" target="frmright">清理缓存</a> | <a href="../recycle.asp" target="_blank">回收站管理</a> | <a href="update.asp?action=updat&amp;submit=清空在线用户" target="frmright">清空在线列表</a></td>
  </tr>
</table>
</td>
</tr>
...
<%
	If Session("packjs") =empty Then 
		...
		packjs ="http://bbs.dvbbs.net/packjs.asp?c="&Dvbbs.Forum_info(0)&"&d="&Replace(Lcase(Dvbbs.Get_ScriptNameUrl),Lcase(Dvbbs.CacheData(33,0)),"")&"&e="&Yrs("Forum_usernum")&"&f="&Yrs("Forum_PostNum")&"&g="&Dvbbs.Forum_info(5)&"&h="&IsSqlDatabase&"&i=Dvbbs Version "&Dvbbs.Forum_Version&"&j="&Yrs("Forum_TopicNum")&"&k="&MyBoardOnline.Forum_Online&"&l="&Dvbbs.Forum_ChanSetting(0)
		Yrs.close
		set Yrs=nothing

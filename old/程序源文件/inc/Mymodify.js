...
function first(preP,preC,formname,selectP,selectC)
{
	...
	cityareaname[5]=new Array('广州','珠海','中山','佛山','东莞','清远','肇庆','阳江','湛江','韶关','惠州','河源','汕尾','汕头','茂名','梅州','潮州','江门','揭阳','云浮');
	if (selectP=='07')
	{ 
...
/*
function ckeckBrowser(formname,preP,index)
{
	if(document.all)
	{
		eval('document.'+formname+'.'+preP+'.options['+index+']=tempoption;');
	}
	else
	{
		eval('document.forms['+formname+'].'+preP+'.options['+index+']=tempoption;');
	}
}*/